...
exports.addProduct = async (req, res) => {
  try {
    ...
    if (!productName || !category) {
      return res.status(400).json({ success: false, message: "productName and category required" });
    }
    ...
    if (thumbnailFile) console.log(`Thumbnail file: ${thumbnailFile.originalname}`);
...
    // Safely parse all fields from form-data
    const updatedFields = {
